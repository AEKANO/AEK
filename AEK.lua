...
local url,res = https.request('https://apiaek.ml/SourceCh.php?id='..msg.sender_user_id_)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(data.ChatMember.AEK).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
Var = true
end
return Var
...
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('https://dev-abs.ml/Api/ProxTube.php?Put=Photo&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&UserId='..data.sender_user_id_..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("❦ ⁞ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('https://dev-abs.ml/Api/ProxTube.php?Put=Video&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("❦ ⁞ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('https://dev-abs.ml/Api/ProxTube.php?Put=Audio&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("❦ ⁞ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('https://dev-abs.ml/Api/ProxTube.php?Put=Voice&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
end
...
local Abbs = DataText:match('/LinkInline:(.*)')
...
local Abbs = DataText:match('/LinkText:(.*)')
if tonumber(Abbs) == tonumber(data.sender_user_id_) then
...
local Aeek = DataText:match('/DelRed:'..tonumber(data.sender_user_id_)..'(.*)')
EditMsg(Chat_Id2, Msg_Id2, "❦ ⁞ الكلمه ↫ "..Aeek.." تم حذفها") 
DevAek:del(AEK..'Aek:Text:GpTexts'..Aeek..data.chat_id_)
DevAek:srem(AEK..'Aek:Manager:GpRedod'..data.chat_id_,Aeek)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Aeek = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevAek:smembers(AEK..'Aek:Text:GpTexts'..Aeek..data.chat_id_)
if DevAek:get(AEK..'Aek:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "❦ ⁞ تم انهاء وحفظ ↫ "..#List.." من الردود المتعدده للامر ↫ "..Aeek) 
...
local Aeek = DataText:match('/DelRedod:'..tonumber(data.sender_user_id_)..'(.*)')
if DevAek:get(AEK..'Aek:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "❦ ⁞ تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..Aeek) 
DevAek:del(AEK..'Aek:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
DevAek:del(AEK..'Aek:Text:GpTexts'..Aeek..data.chat_id_)
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر الادمنيه",callback_data="/HelpList2:"..data.sender_user_id_},{text="اوامر الحمايه",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_},{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_},{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="اخفاء القائمه",callback_data="/HideHelpList:"..data.sender_user_id_}}}
...
❦ ⁞ رابط الحذف • نزلني • اطردني • المطور • المبرمج
❦ ⁞ منو ضافني • مشاهدات المنشور • الرابط 
❦ ⁞ رقمي • ايدي المجموعه • معلومات المجموعه 
❦ ⁞ نسبه الحب • نسبه الكره • نسبه الغباء • ميمز
❦ ⁞ نسبه الرجوله • نسبه الانوثه • التفاعل • الوقت
❦ ⁞ لقبي • نبذتي • صورتي • صورتي+رقم صورتك
━───━ ❦ ━───━
❦ ⁞ صلاحياتي
❦ ⁞ لقبه + بالرد
❦ ⁞ كول + الكلمه
...
if text == "ترتيب الاوامر" or text == "اختصار الاوامر" then
...
send(msg.chat_id_, msg.id_,"❦ ⁞ تم إختصار الأوامر بالشكل التالي ↫ ⤈\n━───━ ❦ ━───━\n❦ ⁞ ايدي ↫ ا\n❦ ⁞ تنزيل الكل ↫ تك\n❦ ⁞ رفع مميز ↫ م\n❦ ⁞ رفع ادمن ↫ اد \n❦ ⁞ رفع مدير ↫ مد \n❦ ⁞ رفع منشئ ↫ من \n❦ ⁞ رفع منشئ اساسي ↫ اس  \n❦ ⁞ تعطيل الايدي بالصوره ↫ تعط\n❦ ⁞ تفعيل الايدي بالصوره ↫ تفع\n━───━ ❦ ━───━")  
end
...
local inline = {{{text="• الرابط نص •",callback_data="/LinkText:"..msg.sender_user_id_},{text="• الرابط انلاين •",callback_data="/LinkInline:"..msg.sender_user_id_}},{{text = '❦ ⁞ 🇦.🇪.🇰.🇦.🇳 ❦ 🇹.🇪.🇦.🇲',url="t.me/SoalfLove"}}}
...
if text == 'سمايلات' and ChCheck(msg) or text == 'سمايل' and ChCheck(msg) or text == 'السمايلات' and ChCheck(msg) then
if not DevAek:get(AEK..'Aek:Lock:Games'..msg.chat_id_) then
DevAek2 = {'🍏','🍎','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🏆','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🛎','📤','🎗','🏵','🎖','🏆','🥌','🛷','🚕','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔️','🛡','🔮','🌡','💣','⏱','🛢','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = DevAek2[math.random(#DevAek2)]
DevAek:set(AEK..'Aek:GameNum'..msg.chat_id_,name)
...
if text:match("^(التاريخ)$") and ChCheck(msg) or text:match("^(الوقت)$")  and ChCheck(msg) then
Dev_Aek(msg.chat_id_, msg.id_, 1, '❦ ⁞ الساعه ، '..os.date("%I:%M%p")..' \n❦ ⁞ التاريخ ، '..os.date("%Y/%m/%d")..' \n', 1, 'md')
end
--     Source AEK     --
if text == "السورس" and ChCheck(msg) or text == "سورس" and ChCheck(msg) then 
...
--     Source AEK     --
if text and (text == "تفعيل تاك الكل" or text == "تفعيل تاك للكل" or text == "تفعيل @all" or text == "تفعيل all") and Constructor(msg) and ChCheck(msg) then
if not DevAek:get(AEK..'Aekan:lock_TagAll'..msg.chat_id_) then
Dev_Aek(msg.chat_id_, msg.id_, 1, '❦ ⁞ تم تفعيل تاك للكل سابقاً ', 1, 'md')
else
Dev_Aek(msg.chat_id_, msg.id_, 1, '❦ ⁞ تم تفعيل تاك للكل ', 1, 'md')
DevAek:del(AEK..'Aekan:lock_TagAll'..msg.chat_id_)
 end end
if text and (text == "تعطيل تاك الكل" or text == "تعطيل تاك للكل" or text == "تعطيل @all" or text == "تعطيل all") and Constructor(msg) and ChCheck(msg) then
...
DevAek:set(AEK..'Aekan:lock_TagAll'..msg.chat_id_,true)
 end end
--     Source AEK     --
if Admin(msg) then
...
--     Source AEK     --
if text and (text == 'تفعيل الصوره' or text == 'تفعيل صورتي') and Manager(msg) and ChCheck(msg) then 
local AEKTEAM = '❦ ⁞ اهلا عزيزي ↫ '..AekRank(msg)..' \n❦ ⁞ تم تفعيل جلب الصوره الشخصيه'
Aekmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AEKTEAM, 14, string.len(msg.sender_user_id_))
DevAek:del(AEK..'lock:get:photo'..msg.chat_id_) 
end
if text and (text == 'تعطيل الصوره' or text == 'تعطيل صورتي') and Manager(msg) and ChCheck(msg) then 
local AEKTEAM = '❦ ⁞ اهلا عزيزي ↫ '..AekRank(msg)..' \n❦ ⁞ تم تعطيل جلب الصوره الشخصيه'
Aekmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AEKTEAM, 14, string.len(msg.sender_user_id_))
DevAek:set(AEK..'lock:get:photo'..msg.chat_id_,true)  
end
if text == "صورتي" and not DevAek:get(AEK..'lock:get:photo'..msg.chat_id_) and ChCheck(msg) then
...
--     Source AEK     --
if text and text:match("^صورتي (%d+)$") and not DevAek:get(AEK..'lock:get:photo'..msg.chat_id_) and ChCheck(msg) then
...
if Sudo(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAekConstructor:"..result.sender_user_id_},{text="رفع مطور",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text="رفع مطور ثانوي",callback_data=msg.sender_user_id_..":SetSecondSudo:"..result.sender_user_id_}},{{text = '❦ ⁞ 🇦.🇪.🇰.🇦.🇳 ❦ 🇹.🇪.🇦.🇲',url="t.me/SoalfLove"}}}
elseif SecondSudo(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAekConstructor:"..result.sender_user_id_},{text="رفع مطور",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text = '❦ ⁞ 🇦.🇪.🇰.🇦.🇳 ❦ 🇹.🇪.🇦.🇲',url="t.me/SoalfLove"}}}
elseif SudoBot(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAekConstructor:"..result.sender_user_id_}},{{text = '❦ ⁞ 🇦.🇪.🇰.🇦.🇳 ❦ 🇹.🇪.🇦.🇲',url="t.me/SoalfLove"}}}
...
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text = '❦ ⁞ 🇦.🇪.🇰.🇦.🇳 ❦ 🇹.🇪.🇦.🇲',url="t.me/SoalfLove"}}}
elseif Admin(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_}},{{text = '❦ ⁞ 🇦.🇪.🇰.🇦.🇳 ❦ 🇹.🇪.🇦.🇲',url="t.me/SoalfLove"}}}
end
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
end,nil)
end 
...
if text == "راسلني" then
AEKTEAM = {"ها هلاو","انطق","كول حبي","تفضل"};
...
--     Source AEK     --
if text == "تفعيل انطق" and Manager(msg) and ChCheck(msg) or text == "تفعيل نطقي" and Manager(msg) and ChCheck(msg) then
local AEKTEAM = '❦ ⁞ اهلا عزيزي ↫ '..AekRank(msg)..' \n❦ ⁞ تم تفعيل ميزة انطق'
Aekmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AEKTEAM, 14, string.len(msg.sender_user_id_))
DevAek:del(AEK..'Aek:Antk'..msg.chat_id_) 
end
if text == "تعطيل انطق" and Manager(msg) and ChCheck(msg) or text == "تعطيل نطقي" and Manager(msg) and ChCheck(msg) then
local AEKTEAM = '❦ ⁞ اهلا عزيزي ↫ '..AekRank(msg)..' \n❦ ⁞ تم تعطيل ميزة انطق'
Aekmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AEKTEAM, 14, string.len(msg.sender_user_id_))
DevAek:set(AEK..'Aek:Antk'..msg.chat_id_,true)  
end
if text and text:match("^انطق (.*)$") and not DevAek:get(AEK..'Aek:Antk'..msg.chat_id_) and ChCheck(msg) then
local msg_id = msg.id_/2097152/0.5 
https.request('https://apiAek.ml/SourceProx/Tra.php?Put=Antk&TokenBot='..TokenBot..'&ChatId='..msg.chat_id_..'&Text='..URL.escape(text:match("^انطق (.*)$"))..'&MsgId='..msg_id..'&Name='..DirName)
end
--     Source AEK     --
if text == "تفعيل الترجمه" and Manager(msg) and ChCheck(msg) then
local AEKTEAM = '❦ ⁞ اهلا عزيزي ↫ '..AekRank(msg)..' \n❦ ⁞ تم تفعيل ميزة الترجمه'
Aekmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AEKTEAM, 14, string.len(msg.sender_user_id_))
DevAek:del(AEK..'Aek:Translate'..msg.chat_id_) 
end
if text == "تعطيل الترجمه" and Manager(msg) and ChCheck(msg) then
local AEKTEAM = '❦ ⁞ اهلا عزيزي ↫ '..AekRank(msg)..' \n❦ ⁞ تم تعطيل ميزة الترجمه'
Aekmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AEKTEAM, 14, string.len(msg.sender_user_id_))
DevAek:set(AEK..'Aek:Translate'..msg.chat_id_,true)  
end
if text and text:match("^ترجمه (.*)$") and not DevAek:get(AEK..'Aek:Translate'..msg.chat_id_) and ChCheck(msg) then
Tra = text:match("^ترجمه (.*)$")
Text = '❦ ⁞ اضغط على اللغه لترجمة النص ↫ '..Tra
inline = {{{text="العربيه",callback_data=msg.sender_user_id_..":Tra:ar:"..Tra},{text="الانكليزيه",callback_data=msg.sender_user_id_..":Tra:en:"..Tra}}} 
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
end
--     Source AEK     --
...
if text and text:match("^ضع قوانين$") and ChCheck(msg) or text and text:match("^وضع قوانين$") and ChCheck(msg) or text and text:match("^ضع القوانين$") and ChCheck(msg) or text and text:match("^وضع القوانين$") and ChCheck(msg) then
...
if text and text:match("^مسح قوانين$") and ChCheck(msg) or text and text:match("^حذف قوانين$") and ChCheck(msg) or text and text:match("^حذف القوانين$") and ChCheck(msg) or text and text:match("^مسح القوانين$") and ChCheck(msg) then
Dev_Aek(msg.chat_id_, msg.id_, 1, '❦ ⁞ تم حذف القوانين', 1, 'md')
DevAek:del(AEK..'Aek:rules'..msg.chat_id_)
end
end
if text and text:match("^القوانين$") and ChCheck(msg) or text and text:match("^قوانين$") and ChCheck(msg) then
...
--     Source AEK     --
if text and (text == "تفعيل ميمز" or text == "تفعيل الميمز") and Manager(msg) and ChCheck(msg) then
local AEKTEAM = '❦ ⁞ اهلا عزيزي ↫ '..AekRank(msg)..' \n❦ ⁞ تم تفعيل الميمز بنجاح'
Aekmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AEKTEAM, 14, string.len(msg.sender_user_id_))
DevAek:del(AEK..'Aek:Memes'..msg.chat_id_) 
end
if text and (text == "تعطيل ميمز" or text == "تعطيل الميمز") and Manager(msg) and ChCheck(msg) then
local AEKTEAM = '❦ ⁞ اهلا عزيزي ↫ '..AekRank(msg)..' \n❦ ⁞ تم تعطيل الميمز بنجاح'
Aekmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AEKTEAM, 14, string.len(msg.sender_user_id_))
DevAek:set(AEK..'Aek:Memes'..msg.chat_id_,true)  
end
if text == "ميمز" and not DevAek:get(AEK..'Aek:Memes'..msg.chat_id_) and ChCheck(msg) then
...
--     Source AEK     --
if text and (text == "تفعيل بصمات البوت" or text == "تفعيل البصمات") and Manager(msg) and ChCheck(msg) then
local AEKTEAM = '❦ ⁞ اهلا عزيزي ↫ '..AekRank(msg)..' \n❦ ⁞ تم تفعيل بصمات البوت بنجاح'
Aekmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AEKTEAM, 14, string.len(msg.sender_user_id_))
DevAek:del(AEK..'Aek:hiii'..msg.chat_id_) 
end
if text and (text == "تعطيل بصمات البوت" or text == "تعطيل البصمات") and Manager(msg) and ChCheck(msg) then
...
Aekmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AEKTEAM, 14, string.len(msg.sender_user_id_))
DevAek:del(AEK.."Aek:AetoTube"..msg.chat_id_) 
return false  
end
if text == 'تعطيل اليوتيوب' and Manager(msg) then  
local AEKTEAM = '❦ ⁞ اهلا عزيزي ↫ '..AekRank(msg)..' \n❦ ⁞ تم تعطيل اليوتيوب بنجاح'
Aekmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AEKTEAM, 14, string.len(msg.sender_user_id_))
DevAek:set(AEK.."Aek:AetoTube"..msg.chat_id_,true) 
return false  
end 
if text and text:match('^بحث (.*)$') and not DevAek:get(AEK.."Aek:AetoTube"..msg.chat_id_) and ChCheck(msg) then            
local Text = text:match('^بحث (.*)$') 
local msg_id = msg.id_/2097152/0.5 
https.request('https://dev-aek.ml/Api/ProxTube.php?Put=Search&TokenBot='..TokenBot..'&ChatId='..msg.chat_id_..'&UserId='..msg.sender_user_id_..'&Text='..URL.escape(Text)..'&MsgId='..msg_id..'&Name='..DirName)
end
--     Source AEK     --
if Admin(msg) then
...
ReplyStatus(msg,result.id_,"InlineReplyBy","❦ ⁞ تم تعطيل المجموعه "..dp.title_)  
DevAek:srem(AEK.."Aek:Groups",msg.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
if text == "الاوامر" and Admin(msg) and ChCheck(msg) or text == "اوامر" and Admin(msg) and ChCheck(msg) or text == "مساعده" and Admin(msg) and ChCheck(msg) then
local Help = DevAek:get(AEK..'Aek:Help')
local Text = [[
❦ ⁞ اهلا بك في قائمة الاوامر ↫ ⤈ 
━───━ ❦ ━───━
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر الادمنيه",callback_data="/HelpList2:"..msg.sender_user_id_},{text="اوامر الحمايه",callback_data="/HelpList1:"..msg.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..msg.sender_user_id_},{text="اوامر المدراء",callback_data="/HelpList3:"..msg.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..msg.sender_user_id_},{text="اوامر المطورين",callback_data="/HelpList5:"..msg.sender_user_id_}},{{text="اخفاء القائمه",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
