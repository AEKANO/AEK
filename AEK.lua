...
--     Source AEK     --
local AekRank = function(msg) if SudoId(msg.sender_user_id_) then AEKTEAM  = "المطور" elseif SecondSudo(msg) then AEKTEAM = "المطور" elseif SudoBot(msg) then AEKTEAM = "المطور" elseif ManagerAll(msg) then AEKTEAM = "المدير" elseif AdminAll(msg) then AEKTEAM = "الادمن" elseif AekConstructor(msg) then AEKTEAM = "المالك" elseif BasicConstructor(msg) then AEKTEAM = "المنشئ" elseif Constructor(msg) then AEKTEAM = "المنشئ" elseif Manager(msg) then AEKTEAM = "المدير" elseif Admin(msg) then AEKTEAM = "الادمن" else AEKTEAM = "العضو" end return AEKTEAM end
...
DevAek:del(AEK..'Aek:Text:GpTexts'..Abbs..data.chat_id_)
DevAek:srem(AEK..'Aek:Manager:GpRedod'..data.chat_id_,Abbs)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Abbs = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevAek:smembers(AEK..'Aek:Text:GpTexts'..Abbs..data.chat_id_)
...
if DevAek:sismember(AEK.."Coomds"..msg.chat_id_,DEV_ABBAS) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrAek = DevAek:get(AEK.."Comd:New:rt:Aek:"..DEV_ABBAS..msg.chat_id_)
...
DevAek:set(AEK.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ABBAS) 
...
if DevAek:get(AEK.."Aek:Photo:BotWelcome") then AekPhoto = DevAek:get(AEK.."Aek:Photo:BotWelcome") elseif Aekan.photos_[0] then AekPhoto = Aekan.photos_[0].sizes_[1].photo_.persistent_id_ else AekPhoto = nil end 
...
local UserName = (dp.username_ or "SoalfLove")
Dev_Aek(msg.chat_id_, msg.id_, 1, "❦ ⁞ مالك المجموعه ↫ ["..dp.first_name_.."](T.me/"..UserName..")", 1, "md")  
end,nil)   
end
end
end,nil)   
...
if text == 'تحويل' and not DevAek:get(AEK..'Aek:Thwel:Aek'..msg.chat_id_) and ChCheck(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
local UrlAntk = https.request('https://apiAek.ml/Antk.php?Aek='..URL.escape(text:match("^انطق (.*)$")))
...
UrlZrf = https.request('https://apiAek.ml/zrf.php?Aek='..URL.escape(text)) 
...
local List = DevAek:smembers(AEK..'Aek:Manager:GpRed'..msg.chat_id_)
if #List == 0 then
...
local List = DevAek:smembers(AEK.."Aek:Sudo:AllRed")
if #List == 0 then
Dev_Aek(msg.chat_id_, msg.id_, 1, "❦ ⁞ لا توجد ردود مضافه" ,  1, "md")
return false
end
...
Dev_Aek(msg.chat_id_, msg.id_, 1, '❦ ⁞ Channel ↬ [@SoalfLove]', 1, 'md')    
end 
--     Source AEK     --
