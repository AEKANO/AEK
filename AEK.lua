...
if Status or SudoBot(msg) or Owner(msg) or AekConstructor(msg) or AekConstructor(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or AekSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or SudoBot(msg) or Owner(msg) or AekConstructor(msg) or AekConstructor(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Admin(msg) or AekSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or SudoBot(msg) or AekConstructor(msg) or AekSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or SudoBot(msg) or Cleaner(msg) or AekConstructor(msg) or AekSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
--     Source AEK     --
local AekRank = function(msg) if SudoId(msg.sender_user_id_) then AEKTEAM  = "المطور الاساسي" elseif AekSudo(msg) then AEKTEAM = "المطور" elseif SecondSudo(msg) then AEKTEAM = "المطور الاساسي²" elseif SudoBot(msg) then AEKTEAM = "المطور" elseif AekConstructor(msg) then AEKTEAM = "المالك" elseif Owner(msg) then AEKTEAM = "المالك" elseif BasicConstructor(msg) then AEKTEAM = "المنشئ الأساسي" elseif Constructor(msg) then AEKTEAM = "المنشئ" elseif Manager(msg) then AEKTEAM = "المدير" elseif Admin(msg) then AEKTEAM = "الادمن" else AEKTEAM = "العضو" end return AEKTEAM end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(152221858) then AEKTEAM = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(AEK) then AEKTEAM = 'البوت' elseif SudoId(user_id) then AEKTEAM = 'المطور الاساسي' elseif DevAek:sismember(AEK..'Aek:AekSudo:', user_id) then AEKTEAM = 'المطور الاساسي' elseif DevAek:sismember(AEK..'Aek:SecondSudo:', user_id) then AEKTEAM = 'المطور الاساسي²' elseif DevAek:sismember(AEK..'Aek:SudoBot:', user_id) then AEKTEAM = DevAek:get(AEK.."Aek:SudoBot:Rd"..chat_id) or 'المطور' elseif DevAek:sismember(AEK..'Aek:Owner:'..chat_id, user_id) then AEKTEAM = DevAek:get(AEK.."Aek:Owner:Rd"..chat_id) or 'المالك' elseif DevAek:sismember(AEK..'Aek:AekConstructor:'..chat_id, user_id) then AEKTEAM = 'المالك' elseif DevAek:sismember(AEK..'Aek:BasicConstructor:'..chat_id, user_id) then AEKTEAM = DevAek:get(AEK.."Aek:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevAek:sismember(AEK..'Aek:Constructor:'..chat_id, user_id) then AEKTEAM = DevAek:get(AEK.."Aek:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevAek:sismember(AEK..'Aek:Managers:'..chat_id, user_id) then AEKTEAM = DevAek:get(AEK.."Aek:Managers:Rd"..chat_id) or 'المدير' elseif DevAek:sismember(AEK..'Aek:Admins:'..chat_id, user_id) then AEKTEAM = DevAek:get(AEK.."Aek:Admins:Rd"..chat_id) or 'الادمن' elseif DevAek:sismember(AEK..'Aek:VipMem:'..chat_id, user_id) then  AEKTEAM = DevAek:get(AEK.."Aek:VipMem:Rd"..chat_id) or 'المميز' elseif DevAek:sismember(AEK..'Aek:Cleaner:'..chat_id, user_id) then  AEKTEAM = DevAek:get(AEK.."Aek:Cleaner:Rd"..chat_id) or 'المنظف' else AEKTEAM = DevAek:get(AEK.."Aek:mem:Rd"..chat_id) or 'العضو' end return AEKTEAM end
--     Source AEK     --
...
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..Aek},{text="رفع ادمن",callback_data=data.sender_user_id_..":SetAdmin:"..Aek}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..Aek}}}
end
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..Aek},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..Aek}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..Aek}}}
end
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
local Aek = DataText:match('/Linkinline:'..tonumber(data.sender_user_id_)..'(.*)')
if not DevAek:get(AEK.."Aek:Lock:GpLinksinline"..data.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=data.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..data.chat_id_)) or DevAek:get(AEK.."Private:Group:Link"..data.chat_id_) 
...
local Aek = DataText:match('/LinkText:'..tonumber(data.sender_user_id_)..'(.*)')
if not DevAek:get(AEK..'Aek:Lock:GpLinks'..data.chat_id_) then 
if DevAek:get(AEK.."Aek:Groups:Links"..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "❦ ⁞ Group Link ↬ ⤈ \n━───━ ❦ ━───━\n"..DevAek:get(AEK.."Aek:Groups:Links"..data.chat_id_), 1, "html")
else 
...
if text == "يوتيوب" and ChCheck(msg) or text == "اليوتيوب" and ChCheck(msg) or text == "↫ بوت اليوتيوب ❦" and ChCheck(msg) or text == "بوت اليوتيوب" and ChCheck(msg) or text == "اريد بوت يوتيوب" and ChCheck(msg) or text == "شمرلي بوت يوتيوب" and ChCheck(msg) or text == "يوت" and ChCheck(msg) then local inline = {{{text="• اضغط هنا •",url="https://t.me/Y3Dbot"}}} SendInline(msg.chat_id_,'*❦ ⁞ اضغط للحصول على بوت اليوتيوب*',nil,inline,msg.id_/2097152/0.5) return false end
...
if text == "ايديي" and ChCheck(msg) or text == "❦ ايديي↫" and ChCheck(msg) then Dev_Aek(msg.chat_id_, msg.id_, 1,'❦ ⁞ ايديك ↫ ❨ `'..msg.sender_user_id_..'` ❩', 1, 'md') end
-- Source AEK --
...
--     Source AEK     --
if text and text:match("^صورتي (%d+)$") and DevAek:get(AEK..'Aek:Photo:Profile'..msg.chat_id_) and ChCheck(msg) then
...
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..Aek},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..Aek}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..Aek}}}
end
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text='..URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
...
--     Source AEK     --
if text == 'همسه' and ChCheck(msg) or text == 'الهمسه' and ChCheck(msg) or text == 'همسة' and ChCheck(msg) or text == 'الهمسة' and ChCheck(msg) or text == 'اهمس' and ChCheck(msg) or text == 'همس' and ChCheck(msg) or text == '↫ بوت الهمسه ❦' and ChCheck(msg) then
...
if text == "الرابط" then
local Link = DevAek:get(AEK..'Aek:Link')
local Text = [[
...
ReplyStatus(msg,result.sender_user_id_,"Reply","❦ ⁞ تم تنزيله من ↫ ⤈\n~ ( "..Aeksudo..secondsudo..sudobot..owner..basicconstructor..constructor..manager..admins..vipmem..cleaner.." ) ~")  
else 
...
if not AekConstructor(msg) and DevAek:get(AEK.."Aek:Lock:KickBan"..msg.chat_id_) then 
...
--     Source AEK     --
if text == "قائمه المنع" and AekConstructor(msg) and ChCheck(msg) then
...
Dev_Aek(msg.chat_id_, msg.id_, 1, '❦ ⁞ للمالكين فقط', 1, 'md')
else
...
if text and text:match("^كول (.*)$") and ChCheck(msg) and not DevAek:get(AEK.."Speak:after:me"..msg.chat_id_) then
...
if text and text:match("^انطق (.*)$") and not DevAek:get(AEK..'Aek:Antk:Aek'..msg.chat_id_) and ChCheck(msg) then
...
if text and (text == "متحركه" or text == "❦ متحركه↫") and not DevAek:get(AEK..'Aek:gif:Aek'..msg.chat_id_) and ChCheck(msg) then
Aek = math.random(0,0030); 
local Text ='*❦ ⁞ تم اختيار المتحركه لك*'
keyboard = {}  
...
if text and (text == "ميمز" or text == "❦ ميمز↫") and not DevAek:get(AEK..'Aek:memz:Aek'..msg.chat_id_) and ChCheck(msg) then
Aek = math.random(2,1170); 
local Text ='*❦ ⁞ تم اختيار مقطع الميمز لك*'
keyboard = {}  
...
if text and (text == "غنيلي" or text == "❦ غنيلي↫") and not DevAek:get(AEK..'Aek:Audios:Aek'..msg.chat_id_) and ChCheck(msg) then
Aek = math.random(2,2216); 
local Text ='*❦ ⁞ تم اختيار المقطع الصوتي لك*'
keyboard = {}  
...
if text and (text == "اغنيه" or text == "❦ اغنيه↫" or text == "اغاني") and not DevAek:get(AEK..'Aek:mp3:Aek'..msg.chat_id_) and ChCheck(msg) then
Aek = math.random(14,3059); 
local Text ='*❦ ⁞ تم اختيار الاغنيه لك*'
keyboard = {}  
...
if text and (text == "ريمكس" or text == "❦ ريمكس↫") and not DevAek:get(AEK..'Aek:Remix:Aek'..msg.chat_id_) and ChCheck(msg) then
Aek = math.random(2,0042); 
local Text ='*❦ ⁞ تم اختيار الريمكس لك*'
keyboard = {}  
...
if text and (text == "صوره" or text == "❦ صوره↫") and not DevAek:get(AEK..'Aek:Photo:Aek'..msg.chat_id_) and ChCheck(msg) then
Aek = math.random(1,0075); 
local Text ='*❦ ⁞ تم اختيار الصوره لك*'
keyboard = {}  
...
if text and (text == "انمي" or text == "↫ انمي ❦") and not DevAek:get(AEK..'Aek:Anime:Aek'..msg.chat_id_) and ChCheck(msg) then
Aek = math.random(3,1002); 
local Text ='*❦ ⁞ تم اختيار صورة الانمي لك*'
keyboard = {}  
...
--     Source AEK     --
if text == "مسح الرتب" and AekConstructor(msg) then
local Del = DevAek:get(AEK..'Aek:Del')
local Text = [[
❦ ⁞ اهلا بك في قائمة اوامر الرتب ↫ ⤈ 
━───━ ❦ ━───━
...
--     Source AEK     --
if text == "مسح قائمه المنع" and AekConstructor(msg) then
local Filter = DevAek:get(AEK..'Aek:Filter')
local Text = [[
❦ ⁞ اهلا بك في قائمة المنع ↫ ⤈ 
━───━ ❦ ━───━
...
❦ ⁞ يمكنك التعطيل والتفعيل عن طريق الازرار بلاسفل
━───━ ❦ ━───━
て [𝘈𝘌𝘒𝘈𝘕 𝘊𝘩𝘢??𝘯𝘦𝘭](t.me/SoalfLove)➤
]] 
keyboard = {} 
...
if text and text:match('^بحث (.*)$') and not DevAek:get(AEK.."Aek:WhyTube"..msg.chat_id_) and ChCheck(msg) then            
