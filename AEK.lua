...
--     Source AEK     --
if text ==('تنزيل') and ScCh(msg) then
function prom_reply(extra, result, success)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,dp) 
if dp.first_name_ == false then
Dev_Aek(msg.chat_id_, msg.id_, 1, "❦ ⁞ الحساب محذوف", 1, "md")
...
--     Source AEK     --
if text == "قائمه المنع" and AekConstructor(msg) and ScCh(msg) then
...
--     Source AEK     --
if text and text:match("^حذف القوائم$") and ScCh(msg) or text and text:match("^مسح القوائم$") and ScCh(msg) then
...
--     Source AEK     --
if text and text:match("^حذف جميع الرتب$") and ScCh(msg) or text and text:match("^مسح جميع الرتب$") and ScCh(msg) or text and text:match("^تنزيل جميع الرتب$") and ScCh(msg) then
...
--     Source AEK     --
if text and text:match("^ضع اسم (.*)$") and Manager(msg) and ScCh(msg) then
...
if text and text:match("^ضع صوره$") and ScCh(msg) or text and text:match("^وضع صوره$") and ScCh(msg) then
...
--     Source AEK     --
if text and text:match("^حذف الصوره$") and ScCh(msg) or text and text:match("^مسح الصوره$") and ScCh(msg) then
